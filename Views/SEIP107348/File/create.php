        ...
        <section class="header_part">
            <div class="container">
                <div class="row">
                    <div>
                        <div class="col-md-6">
                            <p class="header_text color_orange">THE LIST OF PICTURE</p>
                        </div>
                        <div class="col-md-6">  					
                ...
                <div class="row col-md-10 col-md-offset-1  custyle">
                    ...
                    <div class="add_book">
                        <div class="add_book_form col-md-8">
                            <h4 class="color_orange">Upload Your File</h4>
                            <form class="" method="post" action="store.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    <input type="file" name="image" class="form-control" id="exampleInputEmail1" placeholder="Email">
                                </div>
