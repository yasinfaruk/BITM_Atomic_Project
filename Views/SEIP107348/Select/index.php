                        ...
                        <nav class="navbar navbar-default" role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="http://localhost/BITM_Atomic_Project/Views/SEIP107348/Select/create.php">ADD CITY</a></li>
                                    <!--<li><a href="#">Link</a></li>-->
...
<?php foreach ($views as $city) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class='btn btn-info btn-xs' href="view.php?id=<?php echo $city['id']; ?>"><span class="glyphicon glyphicon-edit"></span> View </a> 
                                        <a class='btn btn-success btn-xs' href="update.php?id=<?php echo $city['id']; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a> 
                                        <a href="delete.php?id=<?php echo $city['id']; ?>" name="delete" class="btn btn-danger btn-xs delete"><span class="glyphicon glyphicon-remove"></span> Delete</a>
